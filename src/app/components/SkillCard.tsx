...
const skillIcons: Record<string, SkillDefinition> = {
  ...
  RAG: { icon: Database, color: '#4169E1' },
  MCP: { icon: SiModelcontextprotocol, color: '#111111' },
  Claude: { icon: SiClaude, color: '#D97757' },
  Codex: { icon: TbBrandOpenai, color: '#111111' },
  'GitHub Copilot': { icon: SiGithubcopilot, color: '#111111' },
  'Blender MCP': { icon: SiBlender, color: '#E87D0D' },
